...
public class CSharpMathExtension : IMarkdownExtension
{
    ...
    public void Setup(MarkdownPipeline pipeline, IMarkdownRenderer renderer)
    {
        ...
        {
            if (!htmlRenderer.ObjectRenderers.Contains<HtmlCSharpMathInlineRenderer>())
            {
                htmlRenderer.ObjectRenderers.Insert(0, new HtmlCSharpMathInlineRenderer());
            }
            if (!htmlRenderer.ObjectRenderers.Contains<HtmlCSharpMathBlockRenderer>())
            {
                htmlRenderer.ObjectRenderers.Insert(0, new HtmlCSharpMathBlockRenderer());
            }
        }
    }
}
